...
} from "~features/i18n/domain/strategies/direction-change-handlers";

import {
	LocalStorageLocalePersistenceStrategy
} from "~features/i18n/domain/strategies/persistence-strategies";

export class I18nConfigUseCase {

	public handle(): I18nConfig {
		return {
